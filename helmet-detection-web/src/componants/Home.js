...
const Home = props => {
    ...
    function getVideoFilter(){
        ...
        axios({
            ...
            params: {startDate, endDate, selectInput, startTime, endTime, yearData ,monthData}
          })
            .then(response => {
       ...
       <Container className={classes.root}>
           <CssBaseline />
            ...
            <Grid container component={Paper}  square xs={12} className={classes.grid} >
                ...
                <Typography > Enter Date: </Typography>
                    <input type='time' onChange={(e) => setStartTime(e)} />   
                </Grid>
                <Grid item xs={2} marginTop={1}>
                <Typography > Enter Date: </Typography>
                    <input type='time' onChange={(e) => setEndTime(e)} />
                </Grid>
            ...
            <Grid container component={Paper} square xs={12} align='right'>
              ...
              <Grid container component={Paper}  square xs={12} className={classes.grid} >
                  ...
                  <Grid item xs={7} marginTop={1}>
                      ...
                      <DatePicker
                            ...
                            todayButton="ToDay" 
                            selected={monthData} 
                            onChange={(date) => setMonthData(date)}
                            showMonthYearPicker
